...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/bagusweb" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/baguserlangga/" },
  { icon: Instagram, link: "https://www.instagram.com/lanzz.20/?hl=id" }
];
